...
FROM_ADDRESS = 'joeratt.apis@gmail.com'
REPLY_TO_ADDRESS = 'joeratt.apis@gmail.com'

CLIENTS = [
    {
        # You'll need to verify this email
        'email': 'joerattazzi@gmail.com', 
        'first_name': 'Joe',
        'last_name': 'Rattazzi',
        'pet_name': 'Stupid'
    },
...
TEMPLATE_S3_BUCKET = 'python-email-templates-joeratt'
#
#
